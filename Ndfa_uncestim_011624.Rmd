...
In this file we present the code to apply the method presented in Palmero et al. (2023). This method aims to quantify the uncertainty on the Ndfa needed to achieve neutral partial N balance or total N balance. We will show the application of the delta method, bootstrapping, and Bayesian inference to only field pea and white lupin. The same procedure can be used for any other species. For more information, please, see Palmero et al. (2023).
